...
3. 错误上报：Alas 已移除内置 BugReport 错误上报功能，不再主动向远程 API 提交错误日志。
4. 统计上报：Alas 已移除内置 TelemetryReport 遥测上报功能，不再主动向远程 API 提交统计数据。
5. 公告与更新：项目可能访问 GitHub、Gitee、镜像源、PyPI 镜像、依赖下载地址、资源仓库、更新服务器或 CDN，以获取更新代码、下载依赖或资源。
...
1. 用户可以通过项目配置关闭或调整错误保存、截图保存、截图上传、通知推送、LLM 分析、远程访问、MCP 服务等功能。
